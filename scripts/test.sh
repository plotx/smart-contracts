...
start_ganache() { 
  node_modules/.bin/ganache-cli --gasLimit 80000000 -p "$ganache_port" -i 5777 -m "grocery obvious wire insane limit weather parade parrot patrol stock blast ivory" -a 47 -e 100 --gasPrice 0 > /dev/null &
  ganache_pid=$!
}
