...
start_ganache() { 
  node_modules/.bin/ganache-cli --gasLimit 80000000 -p "$ganache_port" -i 5777 -m "grocery obvious wire insane limit weather parade parrot patrol stock blast ivory" -a 67 -e 10000000 > /dev/null &
  ganache_pid=$!
}
