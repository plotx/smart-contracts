...
module.exports = function(deployer, network, accounts){
  deployer.then(async () => {
    ...
    // // let thenTime = new BN(((1585119864+(600)).toString()));
      ...
      let deploymarket = await deployer.deploy(Market ,[1585141869,1585142169,1,2,1,7,1000000000000000,10000,2,2,100],"firstBet","0x47",["0x81A69EE30637601356ff15d6c4a905079b53FCE1","0x81A69EE30637601356ff15d6c4a905079b53FCE1"]);
  });
};
