...
const MarketDaily = artifacts.require('MarketDailyMock');
const MarketHourly = artifacts.require('MarketHourlyMock');
const MarketWeekly = artifacts.require('MarketWeeklyMock');
