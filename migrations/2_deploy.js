...
module.exports = function(deployer, network, accounts){
  deployer.then(async () => {
    ...
    const end = thenTime/1
      ...
      // let deploymarket = await deployer.deploy(Market ,[start,end,1,2,1,7,1000000000000000,10000,2,2,100],"firstBet","0x47",["0x81A69EE30637601356ff15d6c4a905079b53FCE1","0x81A69EE30637601356ff15d6c4a905079b53FCE1"]);
      //  for deploy test case "place bet from nine users with 0% commision and 0% donation" uncomment line 20  code
      let deploymarket = await deployer.deploy(Market ,[start,end,1,2,1,7,1000000000000000,10000,0,0,100],"firstBet","0x47",["0x81A69EE30637601356ff15d6c4a905079b53FCE1","0x81A69EE30637601356ff15d6c4a905079b53FCE1"]);
  });
};
