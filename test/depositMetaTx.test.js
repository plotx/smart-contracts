...
contract("AllMarket", async function([user1, user2, user3, user4, user5, user6, user7, user8]) {
    ...
    it("Should be able to withdraw deposited ETH even without participating", async function() {
    ...
    it("Should be able to withdraw deposited Plot even without participating", async function() {
    ...
    it("Should be able to predict with max deposit after depositing eth and should recv 0 on withdraw", async function() {
        ...
        let functionSignature = encode3("depositAndPlacePrediction(uint,uint,address,uint64,uint256)", 0, 7, ethAddress, 2*1e5, 1);
        await signAndExecuteMetaTx(
          "7c85a1f1da3120c941b83d71a154199ee763307683f206b98ad92c3b4e0af13e",
          user2,
          functionSignature,
    ...
    it("Should revert if tries to bet on incorrect option or with more than deposit amount", async function() {
        ...
        await assertRevert(allMarkets.depositAndPlacePrediction(0, 7, ethAddress, 2*1e5, 10, { from: user2 })); // wrong option
        await assertRevert(allMarkets.depositAndPlacePrediction(0, 7, ethAddress, 2*1e6, 1, { from: user2 })); // insuffecient deposit
    });
    ...
    it("Should not be able to withdraw even after user predicted correctly if market is still in cooling", async function() {
        ...
        await assertRevert(allMarkets.depositAndPlacePrediction(0, 7, ethAddress, 0, 1, { from: user2 })); // should not be able to predict after market expires
    ...
    it("Should be able to withdraw reward and deposited after cooling period is over", async function() {
        ...
        assert.equal(Math.round((ethBalAfter - ethBalBefore)/1e10),Math.round((rewardAmt)/1e10));
    ...
    it("Integrated test case", async function() {
        ...
        let functionSignature = encode3("depositAndPlacePrediction(uint,uint,address,uint64,uint256)", 0, 8, plotusToken.address, 100*1e8, 1);
        await signAndExecuteMetaTx(
          "7c85a1f1da3120c941b83d71a154199ee763307683f206b98ad92c3b4e0af13e",
          user2,
          functionSignature,
        ...
        functionSignature = encode3("depositAndPlacePrediction(uint,uint,address,uint64,uint256)", 0, 8, ethAddress, 1e8, 2);
        await signAndExecuteMetaTx(
        ...
        functionSignature = encode3("depositAndPlacePrediction(uint,uint,address,uint64,uint256)", 0, 9, ethAddress, 0.1*1e8, 1);
        await signAndExecuteMetaTx(
          "7c85a1f1da3120c941b83d71a154199ee763307683f206b98ad92c3b4e0af13e",
          user2,
          functionSignature,
        ...
        functionSignature = encode3("depositAndPlacePrediction(uint,uint,address,uint64,uint256)", 0, 9, plotusToken.address, 200*1e8, 2);
        await signAndExecuteMetaTx(
          "141319b1a84827e1046e93741bf8a9a15a916d49684ab04925ac4ce4573eea23",
          user5,
          functionSignature,
        ...
        functionSignature = encode3("depositAndPlacePrediction(uint,uint,address,uint64,uint256)", 0, 10, plotusToken.address, 500*1e8, 2);
        await signAndExecuteMetaTx(
          "7c85a1f1da3120c941b83d71a154199ee763307683f206b98ad92c3b4e0af13e",
          user2,
          functionSignature,
        ...
        functionSignature = encode3("depositAndPlacePrediction(uint,uint,address,uint64,uint256)", 0, 10, ethAddress, 1e8, 1);
        await signAndExecuteMetaTx(
          "141319b1a84827e1046e93741bf8a9a15a916d49684ab04925ac4ce4573eea23",
          user5,
          functionSignature,
        ...
        functionSignature = encode3("depositAndPlacePrediction(uint,uint,address,uint64,uint256)", 0, 11, ethAddress, 0.5*1e8, 1);
        await signAndExecuteMetaTx(
          "7c85a1f1da3120c941b83d71a154199ee763307683f206b98ad92c3b4e0af13e",
          user2,
          functionSignature,
        ...
        functionSignature = encode3("depositAndPlacePrediction(uint,uint,address,uint64,uint256)", 0, 11, plotusToken.address, 200*1e8, 2);
        await signAndExecuteMetaTx(
          "141319b1a84827e1046e93741bf8a9a15a916d49684ab04925ac4ce4573eea23",
          user5,
          functionSignature,
        ...
        functionSignature = encode3("withdraw(uint,uint256,uint)", toWei(100),toWei(0.1), 100);
        await signAndExecuteMetaTx(
          "7c85a1f1da3120c941b83d71a154199ee763307683f206b98ad92c3b4e0af13e",
          user2,
          functionSignature,
        ...
        assert.equal(Math.round((ethBalAfter-ethBalBefore/1)/1e5),0.1*1e13);
        ...
        assert.equal(Math.round((ethBalAfter2-ethBalAfter/1)/1e5),0.3*1e13);
        ...
        assert.equal(Math.round((ethBalAfter-ethBalBefore/1)/1e5),0.994005*1e13);
        assert.equal(plotBalAfter-plotBalBefore,toWei(99.95));

        await assertRevert(allMarkets.withdraw(0,0,100,{from:user2}));
        ...
        assert.equal(Math.round((ethBalAfter-ethBalBefore/1)/1e5),0.4995*1e13);
