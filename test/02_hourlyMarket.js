...
contract('hourly Market', function([
  ...
  let MarketInstance   
    ...
    it('get option price',async function(){
        ...
        await increaseTime(600+600);
        // assert.equal(getPrice/1,4)
        const getPrice111 = await marketInstance.getPrice(1);
        console.log(getPrice111/1)
    ...
    //     await marketInstance._closeBet();
    //     await marketInstance.calculateBetResult(9790);
    ...
    //     await marketInstance.calculateBetResult(100);
    //     const WinningOption = await marketInstance.WinningOption()
    ...
    //     const balancePlBefore11 = await web3.eth.getBalance(plotusNewAddress);
    //     assert.equal(((balancePlBefore11/1e18)/1).toFixed(7),(((balancePlBefore1/1e18)+13.50943396)/1).toFixed(7))
    //     // assert.equal(((balancePlBefore11/1e18)/1).toFixed(9),(((balancePlBefore1/1e18)+13.50943396)/1).toFixed(9))
    // })
