...
contract('Market', function([
  ...
  let MarketInstance   
    beforeEach(async () => {
        ...
        // console.log("master instance",masterInstance);
        plotusNewAddress = await masterInstance.plotusAddress();
        console.log("plotus new address",plotusNewAddress);
        ...
        const markets = await plotusNewInstance.allMarkets(1)
        // console.log("markets",markets);
        marketInstance = await Market.at(markets);
        assert.ok(marketInstance);
        const addressOfMarket = marketInstance.address;
        console.log("markets address",addressOfMarket);
    ...
    it('1. place bet from nine users with 2% commision and 2% donation',async function() {
      ...
      console.log((beforeClaimUser1/1)/1e18)
      ...
      const afterClaimUser1 = await web3.eth.getBalance(user1);
       console.log((afterClaimUser1/1)/1e18)
    ...
    it('2. place bet from nine users with 0% commision and 0% Donation',async function(){
      ...
      // console.log("latestTime ",await latestTime())
      ...
      // console.log("master instance",masterInstance);
      plotusNewAddress = await masterInstance.plotusAddress();
      console.log("plotus new address 2",plotusNewAddress);
      plotusNewInstance = await Plotus.at(plotusNewAddress);
      const addNewMarket = await plotusNewInstance.addNewMarket([start,end,1,2,1,7,1000000000000000,10000,0,0,100],"firstBet","0x47",["0xcd7e5d0cF2908850D185Ee9cc6377D6bb6DF0567","0xcd7e5d0cF2908850D185Ee9cc6377D6bb6DF0567"])
      const markets = await plotusNewInstance.allMarkets(2);
      const length = await plotusNewInstance.getAllMarketsLen(); 
      console.log("marktes length",length/1);
      ...
      console.log("markets address 2",addressOfMarket);
      ...
      // assert.equal(getbrttingpoint8/1,140);
      const ClaimDonation = await web3.eth.getBalance("0xcd7e5d0cF2908850D185Ee9cc6377D6bb6DF0567")
      console.log((ClaimDonation/1)/1e18)
      const commision = await marketInstance3.commision()
      console.log("before",commision/1)
      const commision12 = await marketInstance3.commissionPerc()
      console.log("before commissionPerc",commision12/1)
      await increaseTime(610);
      await marketInstance3._closeBet(100);
      // const check = await marketInstance.getReward(user1);
      // console.log((check/1)/1e18)
      // const betting await marketInstance.userPoints();
      // console.log("userbetting ",betting/1)
       const commision1 = await marketInstance3.commision()
      console.log("after",commision1/1)
      const ClaimDonation1 = await web3.eth.getBalance("0xcd7e5d0cF2908850D185Ee9cc6377D6bb6DF0567")
    ...
    //   // console.log("master instance",masterInstance);
    //   plotusNewAddress = await masterInstance.plotusAddress();
    //   console.log("plotus new address 3",plotusNewAddress);
    //   plotusNewInstance = await Plotus.at(plotusNewAddress);
    //   const addNewMarket = await plotusNewInstance.addNewMarket([start,end,1,2,1,7,1000000000000000,10000,0,0,100],"firstBet","0x47",["0xcd7e5d0cF2908850D185Ee9cc6377D6bb6DF0567","0xcd7e5d0cF2908850D185Ee9cc6377D6bb6DF0567"])
    //   const markets = await plotusNewInstance.allMarkets(3)
    //   console.log("markets 3",markets);
    //   marketInstance4 = await Market.at(markets);
    //   assert.ok(marketInstance4);
    //   const addressOfMarket = marketInstance4.address;
    //   console.log("markets address 3",addressOfMarket);
    ...
    //   plotusNewInstance = await Plotus.at(plotusNewAddress);
    //   const addNewMarket = await plotusNewInstance.addNewMarket([start,end,1,2,1,7,1000000000000000,10000,2,2,100],"firstBet","0x47",["0xcd7e5d0cF2908850D185Ee9cc6377D6bb6DF0567","0xcd7e5d0cF2908850D185Ee9cc6377D6bb6DF0567"])
    //   const markets = await plotusNewInstance.allMarkets(4)
    //   console.log("markets 4",markets);
    //   marketInstance1 = await Market.at(markets);
    //   assert.ok(marketInstance1);
    //   const addressOfMarket = marketInstance1.address;
    //   console.log("markets address 4",addressOfMarket);
    ...
    //   // console.log("master instance",masterInstance);
    //   plotusNewAddress = await masterInstance.plotusAddress();
    //   console.log("plotus new address 4",plotusNewAddress);
    //   plotusNewInstance = await Plotus.at(plotusNewAddress);
    //   const addNewMarket = await plotusNewInstance.addNewMarket([start,end,1,2,1,7,1000000000000000,10000,2,2,100],"firstBet","0x47",["0xcd7e5d0cF2908850D185Ee9cc6377D6bb6DF0567","0xcd7e5d0cF2908850D185Ee9cc6377D6bb6DF0567"])
    //   const markets = await plotusNewInstance.allMarkets(5);
    //   console.log("markets 5",markets);
    //   marketInstance2 = await Market.at(markets);
    //   assert.ok(marketInstance2);
    //   const addressOfMarket = marketInstance2.address;
    //   console.log("markets address 5",addressOfMarket);
