...
contract('Market', function([
  ...
  let MarketInstance   
    ...
    it('1. place bet from nine users with 2% commision and 2% donation',async function(){
        ...
        // market callClaimedEvent
        // const user1balance  = claimReward.logs[0].args.callClaimedEvent;
        // console.log("balance",user1balance/1)
        // console.log((await marketInstance.getReward(user1))/1)
    ...
    //     console.log("balance of plotus ",balancePlBefore/1)
    //     await marketInstance._closeBet(100);
    //     const WinningOption = await marketInstance.WinningOption()
    ...
    //     console.log("balance of plotus ",balancePlAfter/1)
    ...
    //     assert.equal(((balancePlAfter/1)/1e18).toFixed(2),((balancePlBefore/1)/1e18).toFixed(2)+((balanceOfPool/1)/1e18).toFixed(2));
    //     // assert.equal(ClaimDonation1/1,ClaimDonation/1);
    ...
    //   plotusNewInstance = await Plotus.at(plotusNewAddress);
    //   const addNewMarket = await plotusNewInstance.addNewMarket([start,end,1,2,1,7,1000000000000000,10000,2,2,100,5,10],"firstBet","0x47",["0xcd7e5d0cF2908850D185Ee9cc6377D6bb6DF0567","0xcd7e5d0cF2908850D185Ee9cc6377D6bb6DF0567"])
    //   const length = await plotusNewInstance.getAllMarketsLen(); 
